...
SAVE_PATH="${WORK_DIR}/exp/Qwen2.5-Search-R1-7B-baseline"
...
ROLLOUT_ARGS=(
   ...
   --rollout_max_tokens_per_gpu 24576

   --max_samples 1280000000
   --max_epochs 1
   --num_episodes 1
)
...
# CUDA_VISIBLE_DEVICES=4,5,6,7 ray start --head --num-gpus=4 --temp-dir="${RAY_TMPDIR:-${TMPDIR:-/tmp}/ray}"
# ray start --head --temp-dir="${RAY_TMPDIR:-${TMPDIR:-/tmp}/ray}"
